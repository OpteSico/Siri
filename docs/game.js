...
　`2桁目は${b < 4 ? '0～3' : b < 7 ? '4～6' : '7～9'}のいずれか`,
  ...
  `1桁目と2桁目の差は${Math.abs(a - b)}`,
  `1桁目と3桁目の差は${Math.abs(a - c)}`,
  `1桁目と4桁目の差は${Math.abs(a - d)}`,
  `2桁目と3桁目の差は${Math.abs(b - c)}`,
  `2桁目と4桁目の差は${Math.abs(b - d)}`,
  `3桁目と4桁目の差は${Math.abs(c - d)}`,

  `2桁目と3桁目の積は${Math.abs(b * c)}`,
  `1桁目と3桁目の積は${Math.abs(a * c)}`,
  `2桁目と4桁目の積は${Math.abs(b * d)}`,
